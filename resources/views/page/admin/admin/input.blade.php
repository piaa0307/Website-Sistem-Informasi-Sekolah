<div class="card rounded-0 bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: #663259;background-size: auto 100%; background-image: url({{asset('keenthemes/media/misc/taieri.svg')}})">
    ...
    <div class="card-body container pt-10 pb-8">
        ...
        <ol class="breadcrumb text-muted fs-6 fw-bold">
            <li class="breadcrumb-item pe-3 text-white">Data Admin</li>
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                                ...
                                <input type="text" name="name" class="form-control form-control-solid" placeholder="Nama" value="{{$admin->name}}" />
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                                <label for="phone" class="required form-label">No HP</label>
                                <input type="text" name="phone" class="form-control form-control-solid" placeholder="No HP" value="{{$admin->phone}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                                <label for="email" class="required form-label">Email</label>
                                <input type="email" name="email" class="form-control form-control-solid" placeholder="Email" value="{{$admin->email}}"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
