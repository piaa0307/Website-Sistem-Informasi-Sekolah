<x-app-layout title="Data Pengumuman">
  <!--begin::Search form-->
  <div id="content_list">
    <div class="card rounded-0 bgi-no-repeat bgi-position-x-end bgi-size-cover"
      ...
      <div class="card-body container pt-10 pb-8">
        ...
        <div class="d-flex align-items-center">
          <h1 class="fw-bold me-3 text-white">Data Pengumuman</h1>
        ...
        <div class="d-flex flex-column">
          ...
          <div class="d-lg-flex align-lg-items-center">
              ...
              <div
                ...
                <div class="row flex-grow-1 mb-5 mb-lg-0">
                  ...
                  <div class="col-lg-12 d-flex align-items-center mb-3 mb-lg-0">
                    ...
                    <!--end::Svg Icon-->
                    <!--begin::Input-->
                    <input type="text" class="form-control form-control-flush flex-grow-1" onkeyup="load_list(1);"
                      name="keywords" placeholder="Pencarian..." />
                    <!--end::Input-->
                  </div>
                  <!--end::Col-->
                </div>
            ...
            <!--begin::Action-->
            <div class="d-flex align-items-center">
              <a class="fw-bold link-white fs-5" href="javascript:;"
                onclick="load_input('{{ route('admin.announcement.create') }}');">Tambah Data</a>
            </div>
            <!--end::Action-->
          </div>
          <!--end::Block-->
