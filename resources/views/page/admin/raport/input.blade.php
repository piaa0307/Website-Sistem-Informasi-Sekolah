                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                ...
                                <input type="text" id="kkn" name="kkn" class="form-control form-control-solid" placeholder="KKN"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <div class="mb-10">
                                <label for="url" class="required form-label">Nilai Akhir</label>
                                <input type="text" id="akhir" name="akhir" class="form-control form-control-solid" placeholder="Nilai Akhir"/>
                            </div>
                        </div>
