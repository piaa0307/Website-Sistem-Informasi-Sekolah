                ...
                <form id="form_input">
                    <div class="row mb-7"> 
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="mb-10">
                            @foreach ($raport as $item)
                                <label for="url" class="required form-label">KKN</label>
                                <input type="text" id="kkn" name="kkn" class="form-control form-control-solid" placeholder="{{$item->kkn}}"/>
                            @endforeach
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            ...
                            @foreach ($raport as $item)
                                ...
                                <input type="text" id="akhir" name="akhir" class="form-control form-control-solid" placeholder="{{$item->akhir}}"/>
                            @endforeach
                            </div>
                        </div>
