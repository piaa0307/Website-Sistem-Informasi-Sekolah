<x-app-layout title="Data Kehadiran Jadwal {{$schedule->start_at->format('j F Y')}}">
    <!--begin::Search form-->
    <div id="content_list">
        <div class="card rounded-0 bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: #663259;background-size: auto 100%; background-image: url({{asset('keenthemes/media/misc/taieri.svg')}})">
            ...
            <div class="card-body container pt-10 pb-8">
                ...
                <div class="d-flex align-items-center">
                    <h1 class="fw-bold me-3 text-white">Data Kehadiran Pelajaran {{$schedule->course->title}} - Kelas {{$schedule->room->title}} | Tanggal {{$schedule->start_at->format('j F Y')}}</h1>
