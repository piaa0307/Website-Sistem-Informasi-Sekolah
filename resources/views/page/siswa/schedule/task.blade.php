                ...
                <form id="form_input">
                    <div class="row mb-7">
                        ...
                        <div class="min-w-150px text-end">
                            @if ($progress->id)
                            <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('siswa.task.update',$progress->id)}}','PATCH','Simpan');" class="btn btn-primary">Simpan</button>
                            @else
