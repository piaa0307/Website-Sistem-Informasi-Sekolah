            ...
            <div class="card-body container pt-10 pb-8">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-lg-flex align-lg-items-center">
                            ...
                            <div class="rounded d-flex flex-column flex-lg-row align-items-lg-center bg-white p-5 w-xxl-850px h-lg-60px me-lg-10 my-5">
                                ...
                                <div class="row flex-grow-1 mb-5 mb-lg-0">
                                    ...
                                    <div class="col-lg-6 d-flex align-items-center mb-3 mb-lg-0">
                                        ...
                                        <!--end::Svg Icon-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-flush flex-grow-1" onkeyup="load_list(1);" id="start" name="start" value="{{date('Y-m-01')}}" placeholder="Tanggal..." />
                                        <!--end::Input-->
                                    </div>
                                    <div class="col-lg-6 d-flex align-items-center mb-5 mb-lg-0">
                                        ...
                                        <!--end::Svg Icon-->
                                        <!--begin::Select-->
                                        <input type="text" class="form-control form-control-flush flex-grow-1" onkeyup="load_list(1);" id="end" name="end" value="{{date('Y-m-d')}}" placeholder="Tanggal..." />
                                        <!--end::Select-->
                                    </div>
                                    <!--end::Col-->
                                </div>
                        ...
                        <!--begin::Action-->
                        <div class="d-flex align-items-center">
                            <a class="fw-bold link-white fs-5" href="javascript:;" onclick="load_input('{{route('guru.schedule.create')}}');">Tambah Data</a>
                        </div>
                        <!--end::Action-->
                    </div>
                    <!--end::Block-->
